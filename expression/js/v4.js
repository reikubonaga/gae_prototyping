...
function loop(){
    ...
    if(renderReady==8){
        eyemove(0.03064066852367686,-0.22222222222222232);
        canRendering = true;
    }
    if(canRendering){
        var date = new Date();
        ...
        if(nowBlink>50){
            ...
            if(nextBlinkTime<nowTime){
                ...
                blendBlink(100);
                nowBlink = 100;
                if(Math.floor(Math.random()*3)==1 && blinkNum < 4){
                    nextBlinkTime = date.getTime()+100;
                    blinkNum++;
                }else{
                    nextBlinkTime = date.getTime()+500+Math.floor(Math.random()*30)*100;
                    blinkNum=1;
                }
            }
        }
