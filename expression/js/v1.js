$(document).ready(function(){
        ...
        $("#blendJawRange").slider({range:"max",min:0,max:100,value:0,slide:function(event,ui){
                    blendJaw(ui.value);
                }});
        $("#blendSyncRange").slider(
                {range:"max",min:0,max:100,value:50,
                 slide:function(event,ui){
                        expressval=$("#blendExpressRange").slider("value");
                        blendSync(ui.value,expressval);
                 }}
        );
        $("#blendTwistRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){blendTwist(ui.value)}});
        $("#blendLipRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){
                    blendLip(ui.value)}});
        $("#blendBlinkRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){blendBlink(ui.value)}});
        $("#blendWidthRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){blendWidth(ui.value)}});
        $("#blendExpressRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){blendExpress(ui.value)}});
        $("#blendSymRange").slider({range:"max",min:0,max:100,value:0,slide:function(event,ui){blendSym(ui.value)}});
        $("#blendTongueRange").slider({range:"max",min:0,max:100,value:50,slide:function(event,ui){
                    blendTongue(ui.value)}});
        $("#blendMaleRange").slider({range:"max",min:0,max:100,value:0,
                    slide:function(event,ui){
                    blendMale(ui.value);
                }});
...
var toggleCoords={clientX:0,clientY:0};
var renderReady=0;
...
function init(){
    ...
    renderer=new THREE.WebGLRenderer({clearColor:0,clearAlpha:1,antialias:true});
    ...
    loader.load({model:"model/gingerhead.js",callback:function(geometry){geometry.materials[0][0].shading=THREE.SmoothShading;
    ...
    loader.load({model:"model/gingerLeye.js",callback:function(geometry,meshLeye){meshLeye=new THREE.Mesh(geometry,new THREE.MeshFaceMaterial({color:6316128}));
    ...
    loader.load({model:"model/gingerReye.js",callback:function(geometry,meshReye){meshReye=new THREE.Mesh(geometry,new THREE.MeshFaceMaterial({color:6316128}));
                ...
                renderReady++}});
    loader.load({model:"model/gingerteethbot.js",callback:function(geometry){geometry.materials[0][0].shading=THREE.SmoothShading;
                geometry.materials[0][0].morphTargets=true;
                ...
                renderReady++}});
    loader.load({model:"model/gingerteethtop.js",callback:function(geometry){geometry.materials[0][0].shading=THREE.SmoothShading;
                geometry.materials[0][0].morphTargets=true;
                ...
                renderReady++}});
    loader.load({model:"model/gingertongue.js",callback:function(geometry){geometry.materials[0][0].shading=THREE.SmoothShading;
                geometry.materials[0][0].morphTargets=true;
                ...
                renderReady++}});
    loader.load({model:"model/gingerheadphones.js",callback:function(geometry){meshHP=new THREE.Mesh(geometry,new THREE.MeshPhongMaterial({color:4605510}));
                ...
                headphonesload.textContent=" headphones...loaded!";
                loadingmodal.appendChild(headphonesload);
                renderReady++}});
    loader.load({model:"model/gingerheadband.js",callback:function(geometry){meshHB=new THREE.Mesh(geometry,new THREE.MeshFaceMaterial({color:4605510}));
                ...
                headbandload.textContent=" headband...loaded!";
