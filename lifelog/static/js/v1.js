(function() {
  ...
  Lifelog.ItemView = (function(_super) {
    ...
    ItemView.prototype.screen = function() {
      var el;
      console.log("click");
      el = this.make("div", {
        "class": "screen"
  ...
  Lifelog.IndexView = (function(_super) {
    ...
    IndexView.prototype.render = function() {
      var data, itemView, _i, _len, _ref, _results;
      _ref = this.datas;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        data = _ref[_i];
        itemView = new Lifelog.ItemView;
        _results.push(this.$el.append(itemView.render(data)));
      }
      return _results;
    };
